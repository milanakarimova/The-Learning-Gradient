...
Machine Learning can feel overwhelming at the beginning. There are many topics, formulas, libraries, and words that sound complicated: loss, gradient, validation, overfitting, embeddings, attention, transformers, deployment, monitoring, and many others.
...
This repository will include explanations, definitions, formulas, small code examples, notebooks, and practical projects.
...
I do not want to memorize concepts without understanding them. For every important topic, I will first try to understand the intuition, then write the mathematical idea, then implement a small example in code, and finally reflect on what I understood.
...
The formula and the code are saying the same thing in different languages. The formula speaks mathematics. The code speaks Python.
